...
import com.sugarguide.adapter.Adapter;
import com.sugarguide.app.AppController;
import com.sugarguide.data.Data;
import com.sugarguide.util.Server;
...
public class Logic_Activity2 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = Logic_Activity2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(Logic_Activity2.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view,
                ...
                dialog = new AlertDialog.Builder(Logic_Activity2.this);
    ...
    private void simpan_update() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(Logic_Activity2.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                        adapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Logic_Activity2.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
